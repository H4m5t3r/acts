 ...
 public:
  ...
  struct Config {
    ...
    std::map<std::string, AxisVariant> varBinning = {
        ...
        {"Residual_d0", BoostRegularAxis(100, -0.2, 0.2, "r_{d0} [mm]")},
        // {"Residual_z0", BoostRegularAxis(100, -0.5, 0.5, "r_{z0} [mm]")},
        {"Residual_z0", BoostRegularAxis(100, -30, 30, "r_{z0} [mm]")},
        // {"Residual_phi", BoostRegularAxis(100, -0.01, 0.01, "r_{#phi}
        // [rad]")},
        {"Residual_phi", BoostRegularAxis(100, -0.4, 0.4, "r_{#phi} [rad]")},
        {"Residual_theta",
         //  BoostRegularAxis(100, -0.01, 0.01, "r_{#theta} [rad]")},
         BoostRegularAxis(100, -0.3, 0.3, "r_{#theta} [rad]")},
        // {"Residual_qop", BoostRegularAxis(100, -0.1, 0.1, "r_{q/p}
        // [c/GeV]")},
        {"Residual_qop", BoostRegularAxis(100, -0.04, 0.04, "r_{q/p} [c/GeV]")},
